...
addon_info = {
	...
	"addon_version": "0.5.2.3",
	"addon_changelog": "Correct numeric spoken clock output to use explicit minute and second units instead of colon-separated display notation.",
